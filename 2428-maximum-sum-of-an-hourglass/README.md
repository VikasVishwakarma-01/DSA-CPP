<h2><a href="https://leetcode.com/problems/maximum-sum-of-an-hourglass/?envType=problem-list-v2&envId=array">2428. Maximum Sum of an Hourglass</a></h2><h3>Medium</h3><hr><p>You are given an <code>m x n</code> integer matrix <code>grid</code>.</p>
